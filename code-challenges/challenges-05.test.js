...
const removeThree = (idx, arr) => {
  // Solution code here...
  let outputArr = arr.splice(idx, 3);
  return arr;
};
...
const listFoods = (recipe) => {
  ...
  recipe.ingredients.forEach((element) => {
    ...
    let secoundSlice = firstSlice.slice(firstSlice.indexOf(" ") + 1);
    result.push(secoundSlice);
  });
  return result;
};
