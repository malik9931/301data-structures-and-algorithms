...
const containsW = (str) => {
  // Solution code here...
  let regPattern = /w/g;
  let regExResult = regPattern.test(str);
  return regExResult;
};
...
const isNum = (input) => {
  ...
  let regExResult = regPattern.test(input);
  return regExResult;
};
...
const isCapitalized = (str) => {
  // Solution code here...
  let regPattern = /[A-Z]\w*/g;
  let regExResult = str.match(regPattern);
  return regExResult;
};
...
const citiesAtoJ = (arr) => {
  // Solution code here...
  let regExResult = [];
  let regPattern = /^[A-J]/g;
  arr.forEach((item) => {
    if (regPattern.test(item)) {
      console.log(regPattern.test(item));
      regExResult.push(item);
    }
  });
